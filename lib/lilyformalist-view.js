...
class StatefulComponent {
  ...
  constructor (ly_paths) {
    ...
    this.counter = 0
    this.render_order = this.ly_paths.join(" ")
    console.log(`${this.render_order}`)
...
`
    ...
    //
    // console.log(the_string)
    const filepath = tempWrite.sync('unicorn', "test.ly")
